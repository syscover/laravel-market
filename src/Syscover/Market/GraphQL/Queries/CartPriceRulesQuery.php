...
class CartPriceRulesQuery extends Query
{
    protected $attributes = [
        'name'          => 'CartPriceRulesQuery',
        'description'   => 'Query to get cart price rules'
    ];

    public function type()
    {
        return Type::listOf(GraphQL::type('MarketCartPriceRule'));
    }
