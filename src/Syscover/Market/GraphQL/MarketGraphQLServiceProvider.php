...
class MarketGraphQLServiceProvider
{
    public static function bootGraphQLTypes()
    {
        ...
        GraphQL::addType(\Syscover\Market\GraphQL\Types\CustomerGroupCustomerClassTaxType::class, 'MarketCustomerGroupCustomerClassTax');
        GraphQL::addType(\Syscover\Market\GraphQL\Inputs\CustomerGroupCustomerClassTaxInput::class, 'MarketCustomerGroupCustomerClassTaxInput');
        ...
        // SECTION
        GraphQL::addType(\Syscover\Market\GraphQL\Types\SectionType::class, 'MarketSection');
        GraphQL::addType(\Syscover\Market\GraphQL\Inputs\SectionInput::class, 'MarketSectionInput');
    ...
    public static function bootGraphQLSchema()
    {
        GraphQL::addSchema('default', array_merge_recursive(GraphQL::getSchemas()['default'], [
            'query' => [
                ...
                // CUSTOMER GROUP CUSTOMER CLASS TAX
                'marketCustomerGroupsCustomerClassTaxesPagination'  => \Syscover\Market\GraphQL\Queries\CustomerGroupsCustomerClassTaxesPaginationQuery::class,
                'marketCustomerGroupsCustomerClassTaxes'            => \Syscover\Market\GraphQL\Queries\CustomerGroupsCustomerClassTaxesQuery::class,
                'marketCustomerGroupCustomerClassTax'               => \Syscover\Market\GraphQL\Queries\CustomerGroupCustomerClassTaxQuery::class,
                ...
                // SECTION
                'marketSectionsPagination'                          => \Syscover\Market\GraphQL\Queries\SectionsPaginationQuery::class,
                'marketSections'                                    => \Syscover\Market\GraphQL\Queries\SectionsQuery::class,
                'marketSection'                                     => \Syscover\Market\GraphQL\Queries\SectionQuery::class,
            ...
            'mutation' => [
                ...
                'marketAddCustomerGroupCustomerClassTax'            => \Syscover\Market\GraphQL\Mutations\AddCustomerGroupCustomerClassTaxMutation::class,
                'marketUpdateCustomerGroupCustomerClassTax'         => \Syscover\Market\GraphQL\Mutations\UpdateCustomerGroupCustomerClassTaxMutation::class,
                'marketDeleteCustomerGroupCustomerClassTax'         => \Syscover\Market\GraphQL\Mutations\DeleteCustomerGroupCustomerClassTaxMutation::class,
                ...
                // SECTION
                'marketAddSection'                                  => \Syscover\Market\GraphQL\Mutations\AddSectionMutation::class,
                'marketUpdateSection'                               => \Syscover\Market\GraphQL\Mutations\UpdateSectionMutation::class,
                'marketDeleteSection'                               => \Syscover\Market\GraphQL\Mutations\DeleteSectionMutation::class,
